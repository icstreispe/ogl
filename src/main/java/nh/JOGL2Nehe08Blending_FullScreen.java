...
public class JOGL2Nehe08Blending_FullScreen extends GLCanvas 
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      try {
         ...
         BufferedImage image = 
               ImageIO.read(getClass().getResource(textureFileName));
      ...
      // Ambient light does not come from a particular direction. Need some ambientColor
   ...
   public void display(GLAutoDrawable drawable) {
      ...
      // ------ Render a ro.ics.figures.Prysm with texture ------
