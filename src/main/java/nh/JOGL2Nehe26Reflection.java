...
//import static com.jogamp.opengl.GL2ES1.GL_TEXTURE_GEN_MODE;
...
public class JOGL2Nehe26Reflection implements GLEventListener, KeyListener {
   ...
   public void init(GLAutoDrawable drawable) {
      ...
      // Load all the texture j3d.images
      try {
      ...
      // Set up lighting
      gl.glLightfv(GL_LIGHT0, GL_AMBIENT, lightAmbientValue, 0); // Set the ambientColor lighting for LIGHT0
      gl.glLightfv(GL_LIGHT0, GL_DIFFUSE, lightDiffuseValue, 0); // Set the diffuseColor lighting for LIGHT0
